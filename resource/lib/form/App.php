...
class App
{
    ...
    public function __construct(STRING $formID = NULL, STRING $fakeField = NULL, ARRAY $whiteList = array(), INT $delay = NULL)
    {
    ...
    public function FloodProtect()
    {
        ...
        //If the time since last Form is less than the designated delay time return TRUE (failed);
